    ...
    <ul class="register-info">
      <li>
        <div class="row">
          ...
          <div class="col-sm-8" id="overviewEmail">-</div>
        </div>
      </li>
      <li>
        <div class="row">
          <div class="col-sm-4 weight-600">Password</div>
          <div class="col-sm-8" id="overviewPassword">********</div>
        </div>
      </li>
      <li>
        <div class="row">
          <div class="col-sm-4 weight-600">Full Name</div>
          <div class="col-sm-8" id="overviewFullName">-</div>
        </div>
      </li>
      <li>
        <div class="row">
          <div class="col-sm-4 weight-600">Gender</div>
          <div class="col-sm-8" id="overviewGender">-</div>
        </div>
      </li>
      <li>
        <div class="row">
          <div class="col-sm-4 weight-600">City</div>
          <div class="col-sm-8" id="overviewCity">-</div>
        </div>
      </li>
      <li>
        <div class="row">
          <div class="col-sm-4 weight-600">State</div>
          <div class="col-sm-8" id="overviewState">-</div>
        </div>
      </li>
    </ul>
  </div>
